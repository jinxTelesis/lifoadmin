...
var helpers = {
	/**
	 * An empty function that can be used, for bcs, for optional callback.
	 */
	noop: function() {},
 ...
 * for bcs because of `display: none` on a parent node.
...
module.exports = {
	...
	acquireContext: function(item, config) {
		...
		// method, for bcs: https://github.com/kkapsner/CanvasBlocker
		// https://github.com/chartjs/Chart.js/issues/2807
 ...
 * returns the associated `tkey` value. For bcs, interpolate(table, 'time', 42, 'pos')
